...
class PoseCorrector:
    def __init__(self):
        ...
        self.pose_subscriber = rospy.Subscriber('/pursuer/mavros/local_position/pose', PoseStamped, self.pose_callback)

        # Publisher for the corrected pose
        self.corrected_pose_publisher = rospy.Publisher('/pursuer/corrected_pose', PoseStamped, queue_size=10)
