...
def create_spherical_cap_marker(frame_id, marker_id, position, orientation, slant_height, cap_height, cap_radius, height):
    ...
    marker.pose.position = cap_position
    marker.pose.orientation = orientation
    marker.scale.x = 0.01
...
def main():
    ...
    orientation, cone_height, vertex_angle = calculate_orientation_and_height(position, target_vector, radius)
    ...
    while not rospy.is_shutdown():
        ...
        cap_marker = create_spherical_cap_marker(frame_id, 1, position, orientation, slant_height, cap_height, cap_radius, cone_height)
