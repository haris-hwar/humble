...
class GoToGoal:
    def __init__(self):
        ...
        self.vel_pub = rospy.Publisher('/pursuer/mavros/setpoint_velocity/cmd_vel', TwistStamped, queue_size=10)
        self.odom_sub = rospy.Subscriber('/pursuer/mavros/local_position/odom', Odometry, self.odom_callback)
        ...
        self.goal_pose.pose.position = Point(10.0, 0.0, 5.0)  # Example goal point (x, y, z)
    ...
    def go_to_goal(self):
        ...
        while not rospy.is_shutdown():
            ...
            # Set ROS parameters
            rospy.set_param('/pursuer/azimuth', azimuth)
            rospy.set_param('/pursuer/elevation', elevation)
